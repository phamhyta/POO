...
public class EntityRender {
    ...
    public void animate() {
        ...
        if (entity.isAttacking()) {
            if (currentAnimation < 5) {
                setAnimation(currentAnimation + ATTACK, spriteSheet.getSpriteArray(currentAnimation + ATTACK),
                        entity.getAttackDuration() / 100);
            }
        } else if (entity.isUp()) {
    ...
    public void render(Graphics2D g) {
        ...
        if (entity.isSkill() && entity.getSkillAttack() != null) {
            ...
            g.drawRect((int) entity.getSkillAttack().getPos().getWorldVar().x,
                    (int) entity.getSkillAttack().getPos().getWorldVar().y, entity.getSkillAttack().getSize(),
                    entity.getSkillAttack().getSize());
        }
    }
