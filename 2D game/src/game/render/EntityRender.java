...
public class EntityRender {
    ...
    public void animate() {
        if (entity.isAttacking()) {
            ...
            if (currentAnimation == UP) setAnimation(SKILL_UP, spriteSheet.getSpriteArray(SKILL_UP), 20);
            if (currentAnimation == DOWN) setAnimation(SKILL_DOWN, spriteSheet.getSpriteArray(SKILL_DOWN), 20);
            if (currentAnimation == LEFT) setAnimation(SKILL_LEFT, spriteSheet.getSpriteArray(SKILL_LEFT), 20);
            if (currentAnimation == RIGHT) setAnimation(SKILL_RIGHT, spriteSheet.getSpriteArray(SKILL_RIGHT), 20);
        } else if (entity.isUp()) {
            setAnimation(UP, 5);
            ...
            if (!entity.isAttacking() ) {
                if (currentAnimation == ATTACK_UP) setAnimation(UP, spriteSheet.getSpriteArray(UP), -1);
                if (currentAnimation == ATTACK_DOWN) setAnimation(DOWN, spriteSheet.getSpriteArray(DOWN), -1);
                if (currentAnimation == ATTACK_LEFT) setAnimation(LEFT, spriteSheet.getSpriteArray(LEFT), -1);
                if (currentAnimation == ATTACK_RIGHT) setAnimation(RIGHT, spriteSheet.getSpriteArray(RIGHT), -1);
                if (currentAnimation == SKILL_UP) setAnimation(UP, spriteSheet.getSpriteArray(UP), -1);
                if (currentAnimation == SKILL_DOWN) setAnimation(DOWN, spriteSheet.getSpriteArray(DOWN), -1);
                if (currentAnimation == SKILL_LEFT) setAnimation(LEFT, spriteSheet.getSpriteArray(LEFT), -1);
                if (currentAnimation == SKILL_RIGHT) setAnimation(RIGHT, spriteSheet.getSpriteArray(RIGHT), -1);
    ...
    public void render(Graphics2D g){
        ...
        for(int i=0; i< entity.getSkill().size(); i++){
            if(entity.getSkill().get(i) != null)    entity.getSkill().get(i).getSkillRender().render(g);
        }
    }
